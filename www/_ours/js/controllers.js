			...
			'<a uib-dropdown-toggle href>'+
				'<span class="clear">'+
					'<span class="block m-t-xs">'+
						'<strong class="font-bold">'+user_data.LAST_NAME+'</strong>'+
					'</span>'+
					'<span class="text-muted text-xs block">'+user_data.LAST_LOGGED_IN+'</span>'+
				'</span>'+
			'</a>'+
		'</div>'+
...
function AuthCtrl($scope, $window, $ionicPopup, $state, $http) {
	$scope.data = {};
